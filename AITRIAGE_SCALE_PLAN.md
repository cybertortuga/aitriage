...
### Фаза 8 — Канонический triage artifact — ⏳ В РАБОТЕ
...
- [ ] 8.4 Обновить reusable workflow: передать `--triage-out
...
- [ ] 8.5 Выпустить новый immutable Action image/commit, repin reusable
  workflow и caller.
- [ ] 8.6 Запустить **один** caller workflow и проверить скачанный artifact:
